...
This example demonstrates how to asynchronously invoke a wasm function and replace an object implementing `Read` and `Send` with wasm's stdout, which is a file in this case. Therefore, the wasm output for stdout will be written to the file.
