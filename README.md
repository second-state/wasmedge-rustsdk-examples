...
- [Examples of WasmEdge Rust SDK](#examples-of-wasmedge-rust-sdk)
  - [Host Functions](#host-functions)
    ...
    - [Example: Arguments of non-standard wasm types in wasm function](#example-arguments-of-non-standard-wasm-types-in-wasm-function)
...
### Example: Arguments of non-standard wasm types in wasm function
